<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('properties.transactions')" :active="request()->routeIs('properties.transactions')">
                        {{ __('Mis Transacciones') }}
                    </x-nav-link>

                    <x-nav-link :href="route('properties.active')" :active="request()->routeIs('properties.active')">
                        {{ __('Mis Propiedades Activas') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Agregar botón de propiedades para versión móvil -->
            <x-responsive-nav-link :href="route('properties.transactions')" :active="request()->routeIs('properties.transactions')">
                {{ __('Mis Transacciones') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('properties.active')" :active="request()->routeIs('properties.active')">
                {{ __('Mis Propiedades Activas') }}
            </x-responsive-nav-link>
